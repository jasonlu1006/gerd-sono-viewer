# DICOM Report — 4759675_unknown_IMG00042

> **Chart ID:** `4759675`  
> **Label:** `unknown`  
> **Generated:** 2026-06-05 21:16:12  
> **Source file:** `IMG00042.dcm`  
> **Image:** [4759675_unknown_IMG00042.jpg](./4759675_unknown_IMG00042.jpg)

![4759675_unknown_IMG00042.jpg](./4759675_unknown_IMG00042.jpg)
...
| Parameter | Value |
|-----------|-------|
| **mm per pixel (X)** | `-0.303198` |
| **mm per pixel (Y)** | `0.303198` |
| **px per mm** | `-3.2982` |
...
| `(0008,0013)` | InstanceCreationTime | TM | `091831.805` |
| `(0008,0014)` | InstanceCreatorUID | UI | `1.2.392.200036.9116.6.18.15552579` |
| `(0008,0016)` | SOPClassUID | UI | `1.2.840.10008.5.1.4.1.1.6.1` |
| `(0008,0018)` | SOPInstanceUID | UI | `1.2.392.200036.9116.6.18.15552579.4676.20160115011831820.2.901` |
...
| `(0018,5012)` | FocusDepth | DS | `7.680` |
| `(0018,5022)` | MechanicalIndex | DS | `1.3` |
| `(0018,5024)` | BoneThermalIndex | DS | `0.4` |
| `(0018,5027)` | SoftTissueThermalIndex | DS | `0.4` |
| `(0018,5050)` | DepthOfScanField | IS | `160` |
...
| `(0020,0013)` | InstanceNumber | IS | `42` |
